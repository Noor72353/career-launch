...
- Learned the basics of GitHub Actions and continuous integration
- Created a GitHub Actions workflow for the `main` branch
- Configured CI to run automatically on pushes and pull requests
- Set up Python 3.13 using `actions/setup-python@v5`
- Installed project dependencies and development tools
